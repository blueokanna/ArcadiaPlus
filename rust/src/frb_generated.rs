        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>({
                            crate::api::clear_android_vpn_fd().await;
                        })?;
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::close_connection(api_connection_id).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::get_android_proxy_mode().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::get_android_vpn_fd().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::get_build_info().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__get_corduit_status_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_corduit_status",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::get_corduit_status().await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__get_recursive_dns_status_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_recursive_dns_status",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::get_version().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok =
                            Ok::<_, ()>(crate::api::get_windows_proxy_mode_str().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::get_windows_tun_stats().await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::get_wintun_dll_path().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__initialize_corduit_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    config_json: impl CstDecode<String>,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "initialize_corduit",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::initialize_corduit(api_config_json).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>(crate::api::is_wintun_available().await)?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__reload_corduit_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    config_json: impl CstDecode<String>,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "reload_corduit",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
        ...
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>({
                            crate::api::set_android_proxy_mode(api_mode).await;
                        })?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>({
                            crate::api::set_protect_socket_callback_enabled(api_enabled).await;
                        })?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, ()>(
                    (move || async move {
                        let output_ok = Ok::<_, ()>({
                            crate::api::set_vpn_fd(api_fd).await;
                        })?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::set_windows_proxy_mode(api_mode).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__start_corduit_impl(port_: flutter_rust_bridge::for_generated::MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "start_corduit",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::start_corduit().await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__start_recursive_dns_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "start_recursive_dns",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
...
fn wire__crate__api__stop_corduit_impl(port_: flutter_rust_bridge::for_generated::MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "stop_corduit",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            move |context| async move {
                transform_result_dco::<_, _, String>(
                    (move || async move {
                        let output_ok = crate::api::stop_corduit().await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__stop_recursive_dns_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "stop_recursive_dns",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
...
impl SseDecode for (u64, u64, u64, u64, u64, u64) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_field0 = <u64>::sse_decode(deserializer);
        let mut var_field1 = <u64>::sse_decode(deserializer);
        ...
        let mut var_field5 = <u64>::sse_decode(deserializer);
        return (
...
impl SseDecode for crate::types::RecursiveDnsStatus {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_running = <bool>::sse_decode(deserializer);
        let mut var_listen = <Option<String>>::sse_decode(deserializer);
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::types::RecursiveDnsStatus {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.running.into_into_dart().into_dart(),
            self.listen.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::types::RecursiveDnsStatus
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::types::RecursiveDnsStatus>
    for crate::types::RecursiveDnsStatus
{
    fn into_into_dart(self) -> crate::types::RecursiveDnsStatus {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for (u64, u64, u64, u64, u64, u64) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <u64>::sse_encode(self.0, serializer);
        <u64>::sse_encode(self.1, serializer);
        ...
        <u64>::sse_encode(self.5, serializer);
    }
}

impl SseEncode for crate::types::RecursiveDnsStatus {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.running, serializer);
...
mod io {
    ...
    impl CstDecode<(u64, u64, u64, u64, u64, u64)> for wire_cst_record_u_64_u_64_u_64_u_64_u_64_u_64 {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> (u64, u64, u64, u64, u64, u64) {
            (
                self.field0.cst_decode(),
                self.field1.cst_decode(),
                self.field2.cst_decode(),
    ...
    impl CstDecode<crate::types::RecursiveDnsStatus> for wire_cst_recursive_dns_status {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> crate::types::RecursiveDnsStatus {
    ...
    impl NewWithNullPtr for wire_cst_record_u_64_u_64_u_64_u_64_u_64_u_64 {
        fn new_with_null_ptr() -> Self {
            Self {
                field0: Default::default(),
                field1: Default::default(),
    ...
    impl Default for wire_cst_record_u_64_u_64_u_64_u_64_u_64_u_64 {
        fn default() -> Self {
            Self::new_with_null_ptr()
        }
    }
    impl NewWithNullPtr for wire_cst_recursive_dns_status {
        fn new_with_null_ptr() -> Self {
            Self {
                running: Default::default(),
                listen: core::ptr::null_mut(),
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__clear_android_vpn_fd(port_: i64) {
        wire__crate__api__clear_android_vpn_fd_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__clear_vpn_fd(port_: i64) {
        wire__crate__api__clear_vpn_fd_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__close_active_connection(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__close_all_connections(port_: i64) {
        wire__crate__api__close_all_connections_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__close_all_connections_dto(port_: i64) {
        wire__crate__api__close_all_connections_dto_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__close_connection(
        port_: i64,
        connection_id: *mut wire_cst_list_prim_u_8_strict,
    ) {
        wire__crate__api__close_connection_impl(port_, connection_id)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__close_connection_by_id(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__disable_tun_mode(port_: i64) {
        wire__crate__api__disable_tun_mode_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__enable_tun_mode(port_: i64) {
        wire__crate__api__enable_tun_mode_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__enable_tun_mode_with_mode(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__enable_uwp_loopback(port_: i64) {
        wire__crate__api__enable_uwp_loopback_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__ensure_wintun_dll(port_: i64) {
        wire__crate__api__ensure_wintun_dll_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_active_connections(port_: i64) {
        wire__crate__api__get_active_connections_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_android_proxy_mode(port_: i64) {
        wire__crate__api__get_android_proxy_mode_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_android_vpn_fd(port_: i64) {
        wire__crate__api__get_android_vpn_fd_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_build_info(port_: i64) {
        wire__crate__api__get_build_info_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_connection_stats(port_: i64) {
        wire__crate__api__get_connection_stats_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_connections(port_: i64) {
        wire__crate__api__get_connections_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_connections_dto(port_: i64) {
        wire__crate__api__get_connections_dto_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_corduit_status(port_: i64) {
        wire__crate__api__get_corduit_status_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_dns_config(port_: i64) {
        wire__crate__api__get_dns_config_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_logs(port_: i64, lines: *mut u32) {
        wire__crate__api__get_logs_impl(port_, lines)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_proxies(port_: i64) {
        wire__crate__api__get_proxies_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_proxy_groups(port_: i64) {
        wire__crate__api__get_proxy_groups_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_proxy_mode(port_: i64) {
        wire__crate__api__get_proxy_mode_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_recursive_dns_status(port_: i64) {
        wire__crate__api__get_recursive_dns_status_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_rules(port_: i64) {
        wire__crate__api__get_rules_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_selected_proxy_in_group(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_system_info(port_: i64) {
        wire__crate__api__get_system_info_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_traffic_stats(port_: i64) {
        wire__crate__api__get_traffic_stats_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_traffic_stats_dto(port_: i64) {
        wire__crate__api__get_traffic_stats_dto_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_tun_status(port_: i64) {
        wire__crate__api__get_tun_status_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_version(port_: i64) {
        wire__crate__api__get_version_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_windows_proxy_mode_str(port_: i64) {
        wire__crate__api__get_windows_proxy_mode_str_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_windows_tun_stats(port_: i64) {
        wire__crate__api__get_windows_tun_stats_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__get_wintun_dll_path(port_: i64) {
        wire__crate__api__get_wintun_dll_path_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__init_app(port_: i64) {
        wire__crate__api__init_app_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__initialize_corduit(
        port_: i64,
        config_json: *mut wire_cst_list_prim_u_8_strict,
    ) {
        wire__crate__api__initialize_corduit_impl(port_, config_json)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__is_proxy_running(port_: i64) {
        wire__crate__api__is_proxy_running_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__is_wintun_available(port_: i64) {
        wire__crate__api__is_wintun_available_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__open_uwp_loopback_utility(port_: i64) {
        wire__crate__api__open_uwp_loopback_utility_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__reload_config_from_file(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__reload_config_from_yaml(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__reload_corduit(
        port_: i64,
        config_json: *mut wire_cst_list_prim_u_8_strict,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__select_proxy(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__select_proxy_in_group(
        port_: i64,
        group_name: *mut wire_cst_list_prim_u_8_strict,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_android_proxy_mode(
        port_: i64,
        mode: *mut wire_cst_list_prim_u_8_strict,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_android_vpn_fd(port_: i64, fd: i32) {
        wire__crate__api__set_android_vpn_fd_impl(port_, fd)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_geoip_database_path(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_log_level(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_protect_socket_callback_enabled(
        port_: i64,
        enabled: bool,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_proxy_mode(port_: i64, mode: i32) {
        wire__crate__api__set_proxy_mode_impl(port_, mode)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_vpn_fd(port_: i64, fd: i32) {
        wire__crate__api__set_vpn_fd_impl(port_, fd)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__set_windows_proxy_mode(
        port_: i64,
        mode: *mut wire_cst_list_prim_u_8_strict,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__start_android_vpn(port_: i64) {
        wire__crate__api__start_android_vpn_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__start_corduit(port_: i64) {
        wire__crate__api__start_corduit_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__start_proxy_from_file(
        port_: i64,
        config_path: *mut wire_cst_list_prim_u_8_strict,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__start_proxy_from_yaml(
        port_: i64,
        yaml_config: *mut wire_cst_list_prim_u_8_strict,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__start_recursive_dns(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__start_tun_mode(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__stop_android_vpn(port_: i64) {
        wire__crate__api__stop_android_vpn_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__stop_corduit(port_: i64) {
        wire__crate__api__stop_corduit_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__stop_proxy(port_: i64) {
        wire__crate__api__stop_proxy_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__stop_recursive_dns(port_: i64) {
        wire__crate__api__stop_recursive_dns_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__stop_tun_mode(port_: i64) {
        wire__crate__api__stop_tun_mode_impl(port_)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_all_proxies_latency(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_config(
        port_: i64,
        config_json: *mut wire_cst_list_prim_u_8_strict,
    ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_outbound_latency(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_proxies_latency(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_proxy_latency(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_proxy_latency_dto(
        port_: i64,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_shadowsocks_latency(
        port_: i64,
        server: *mut wire_cst_list_prim_u_8_strict,
        port: u16,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_wire__crate__api__test_tcp_connectivity(
        port_: i64,
        server: *mut wire_cst_list_prim_u_8_strict,
        port: u16,
        timeout_ms: u32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_box_autoadd_u_16(value: u16) -> *mut u16 {
        flutter_rust_bridge::for_generated::new_leak_box_ptr(value)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_box_autoadd_u_32(value: u32) -> *mut u32 {
        flutter_rust_bridge::for_generated::new_leak_box_ptr(value)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_box_autoadd_u_64(value: u64) -> *mut u64 {
        flutter_rust_bridge::for_generated::new_leak_box_ptr(value)
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_String(len: i32) -> *mut wire_cst_list_String {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_active_connection(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_connection_dto(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_connection_info(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_latency_test_result(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_prim_u_8_strict(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_proxy_group_dto(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_proxy_info_dto(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_proxy_latency_dto(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_record_string_u_16(
        len: i32,
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn frbgen_arcadia_cst_new_list_rule_dto(
        len: i32,
    ...
    #[repr(C)]
    #[derive(Clone, Copy)]
    pub struct wire_cst_record_u_64_u_64_u_64_u_64_u_64_u_64 {
        field0: u64,
        field1: u64,
        field2: u64,
        field3: u64,
...
mod web {
    ...
    impl CstDecode<(u64, u64, u64, u64, u64, u64)>
        for flutter_rust_bridge::for_generated::wasm_bindgen::JsValue
    {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> (u64, u64, u64, u64, u64, u64) {
    ...
    impl CstDecode<crate::types::RecursiveDnsStatus>
        for flutter_rust_bridge::for_generated::wasm_bindgen::JsValue
    {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(self) -> crate::types::RecursiveDnsStatus {
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__get_corduit_status(
        port_: flutter_rust_bridge::for_generated::MessagePort,
    ) {
        wire__crate__api__get_corduit_status_impl(port_)
    }
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__get_recursive_dns_status(
        port_: flutter_rust_bridge::for_generated::MessagePort,
    ) {
        wire__crate__api__get_recursive_dns_status_impl(port_)
    }
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__initialize_corduit(
        port_: flutter_rust_bridge::for_generated::MessagePort,
        config_json: String,
    ) {
        wire__crate__api__initialize_corduit_impl(port_, config_json)
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__reload_corduit(
        port_: flutter_rust_bridge::for_generated::MessagePort,
        config_json: String,
    ) {
        wire__crate__api__reload_corduit_impl(port_, config_json)
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__start_corduit(port_: flutter_rust_bridge::for_generated::MessagePort) {
        wire__crate__api__start_corduit_impl(port_)
    }
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__stop_corduit(port_: flutter_rust_bridge::for_generated::MessagePort) {
        wire__crate__api__stop_corduit_impl(port_)
    }
    ...
    #[wasm_bindgen]
    pub fn wire__crate__api__stop_recursive_dns(
        port_: flutter_rust_bridge::for_generated::MessagePort,
    ) {
        wire__crate__api__stop_recursive_dns_impl(port_)
    }

...
#[macro_export]
macro_rules! trace_proxy_connection {
    ($target:expr, $protocol:expr, $body:expr) => {{ $body }};
}
...
#[macro_export]
macro_rules! trace_inbound_connection {
    ($inbound_type:expr, $src_addr:expr, $body:expr) => {{ $body }};
}
...
#[macro_export]
macro_rules! trace_outbound_connection {
    ($outbound_type:expr, $target:expr, $body:expr) => {{ $body }};
}

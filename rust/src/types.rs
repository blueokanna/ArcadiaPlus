...
#[frb]
#[derive(
    Debug, Clone, Serialize, Deserialize, nextjson::NsonSerialize, nextjson::NsonDeserialize,
)]
...
impl ConnectionDto {
    ...
    pub fn from_tracked_connection(
        conn: &crate::core::connection_tracker::TrackedConnection,
    ) -> Self {
        Self {
            id: conn.id.clone(),
...
impl ProxyInfoDto {
    ...
    pub fn from_outbound_config(config: &crate::core::OutboundConfig) -> Self {
        Self {
...
impl ProxyGroupDto {
    ...
    pub fn from_outbound_config(config: &crate::core::OutboundConfig) -> Option<Self> {
...
impl RuleDto {
    ...
    pub fn from_rule_config(config: &crate::core::RuleConfig) -> Self {
        Self {
...
impl DnsConfigDto {
    ...
    pub fn from_dns_config(config: &crate::core::DnsConfig) -> Self {
        Self {

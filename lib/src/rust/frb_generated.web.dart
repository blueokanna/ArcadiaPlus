...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  JSAny cst_encode_record_u_64_u_64_u_64_u_64_u_64_u_64(
    ...
    return [
      ...
      cst_encode_u_64(raw.$3),
      cst_encode_u_64(raw.$4),
      cst_encode_u_64(raw.$5),
      cst_encode_u_64(raw.$6),
    ].jsify()!;
  }

  @protected
  JSAny cst_encode_recursive_dns_status(RecursiveDnsStatus raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_bool(raw.running),
...
class RustLibWire implements BaseWire {
  ...
  void wire__crate__api__get_corduit_status(NativePortType port_) =>
      wasmModule.wire__crate__api__get_corduit_status(port_);
  ...
  void wire__crate__api__initialize_corduit(
    NativePortType port_,
    String config_json,
  ) => wasmModule.wire__crate__api__initialize_corduit(port_, config_json);
...
extension type RustLibWasmModule._(JSObject _) implements JSObject {
  ...
  external void wire__crate__api__get_corduit_status(NativePortType port_);
  ...
  external void wire__crate__api__initialize_corduit(
    NativePortType port_,
    String config_json,
  );

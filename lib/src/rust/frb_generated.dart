...
abstract class RustLibApi extends BaseApi {
  ...
  Future<ProxyStatus> crateApiGetCorduitStatus();
  ...
  Future<void> crateApiInitializeCorduit({required String configJson});
  ...
  Future<String> crateApiStartRecursiveDns({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<ProxyStatus> crateApiGetCorduitStatus() {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          return wire.wire__crate__api__get_corduit_status(port_);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_proxy_status,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiGetCorduitStatusConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiGetCorduitStatusConstMeta =>
      const TaskConstMeta(debugName: "get_corduit_status", argNames: []);
  ...
  Future<RecursiveDnsStatus> crateApiGetRecursiveDnsStatus() {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          return wire.wire__crate__api__get_recursive_dns_status(port_);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_recursive_dns_status,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiGetRecursiveDnsStatusConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  crateApiGetWindowsTunStats() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: DcoCodec(
          decodeSuccessData: dco_decode_record_u_64_u_64_u_64_u_64_u_64_u_64,
          decodeErrorData: dco_decode_String,
        ),
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          return wire.wire__crate__api__initialize_corduit(port_, arg0);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_unit,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiInitializeCorduitConstMeta,
  ...
  TaskConstMeta get kCrateApiInitializeCorduitConstMeta => const TaskConstMeta(
    debugName: "initialize_corduit",
    argNames: ["configJson"],
  );
  ...
  Future<void> crateApiReloadCorduit({required String configJson}) {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          var arg0 = cst_encode_String(configJson);
          return wire.wire__crate__api__reload_corduit(port_, arg0);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_unit,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiReloadCorduitConstMeta,
        argValues: [configJson],
        apiImpl: this,
      ),
    );
  ...
  Future<void> crateApiStartCorduit() {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          return wire.wire__crate__api__start_corduit(port_);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_unit,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiStartCorduitConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStartCorduitConstMeta =>
  ...
  Future<String> crateApiStartRecursiveDns({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          var arg0 = cst_encode_String(listen);
          var arg1 = cst_encode_opt_String(cachePath);
          return wire.wire__crate__api__start_recursive_dns(port_, arg0, arg1);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_String,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiStartRecursiveDnsConstMeta,
        argValues: [listen, cachePath],
        apiImpl: this,
      ),
    );
  }
  ...
  Future<void> crateApiStopCorduit() {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          return wire.wire__crate__api__stop_corduit(port_);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_unit,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiStopCorduitConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiStopCorduitConstMeta =>
  ...
  Future<void> crateApiStopRecursiveDns() {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          return wire.wire__crate__api__stop_recursive_dns(port_);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_unit,
          decodeErrorData: dco_decode_String,
        ),
        constMeta: kCrateApiStopRecursiveDnsConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  @protected
  (BigInt, BigInt, BigInt, BigInt, BigInt, BigInt)
  sse_decode_record_u_64_u_64_u_64_u_64_u_64_u_64(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_field0 = sse_decode_u_64(deserializer);
    ...
    var var_field5 = sse_decode_u_64(deserializer);
    return (
      var_field0,
      var_field1,
      var_field2,
  ...
  void sse_encode_record_u_64_u_64_u_64_u_64_u_64_u_64(
    ...
    sse_encode_u_64(self.$6, serializer);
  }

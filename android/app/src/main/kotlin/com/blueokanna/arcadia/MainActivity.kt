        ...
        methodChannel?.setMethodCallHandler { call, result ->
            ...
            when (call.method) {
                "startVpn" -> {
                    ...
                    pendingAllowLan = call.argument<Boolean>("allowLan") ?: true
    ...
    private fun startVpnService(result: MethodChannel.Result, mode: String) {
        ...
        try {
            ...
            if (intent != null) {
                ...
                try {
                    @Suppress("DEPRECATION") startActivityForResult(intent, VPN_REQUEST_CODE)
        ...
        mainScope.launch {
            try {
                ...
                if (fd >= 0) {
                    ...
                    result.success(mapOf("success" to true, "fd" to fd, "mode" to mode))
                } else {
                    ...
                    result.success(
                            mapOf(
                                    ...
                                    "fd" to -1,
                                    "error" to
                                            "Failed to start VPN - VPN interface could not be established"
                            )
                    )
                }
            } catch (e: Exception) {
                ...
                Activity.RESULT_CANCELED -> {
                    ...
                    result?.success(
                            mapOf(
                                    ...
                                    "fd" to -1,
                                    "error" to
                                            "VPN permission request failed with code: $resultCode"
                            )
                    )
                }
            }
